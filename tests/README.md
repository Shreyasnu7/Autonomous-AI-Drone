...
| `test_depth_projection.py` | Camera depth geometry | 8 | nothing (pure numpy) |
...
python3 tests/test_depth_projection.py  #  8 checks: camera depth geometry (no hardware needed)
```
